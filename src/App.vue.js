...
function __VLS_template() {
    ...
    for (var _i = 0, _a = __VLS_getVForSourceType((__VLS_ctx.data)); _i < _a.length; _i++) {
        var item = _a[_i][0];
        __VLS_elementAsFunction(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ key: ((__VLS_ctx.nanoid())) }, { class: ("w-[4.5rem] h-[4.5rem] flex items-center justify-center bg-[#0c132a] rounded-[1rem]") }));
        __VLS_elementAsFunction(__VLS_intrinsicElements.img)({
            src: ((item.img)),
            alt: ((item.alt)),
        });
